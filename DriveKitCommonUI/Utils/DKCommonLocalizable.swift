...
public enum DKCommonLocalizable: String {
    ...
    ecodrivingSpeedGoogMaintain = "dk_common_ecodriving_speed_good_maintain",
    ecodrivingSpeedWeakMaintain = "dk_common_ecodriving_speed_weak_maintain",
    ecodrivingSpeedBadMaintain = "dk_common_ecodriving_speed_bad_maintain",
    ecodrivingDecelarationLow = "dk_common_ecodriving_decel_low",
    ecodrivingDecelarationWeak = "dk_common_ecodriving_decel_weak",
    ecodrivingDecelarationGood = "dk_common_ecodriving_decel_good",
    ecodrivingDecelarationStrong = "dk_common_ecodriving_decel_strong",
    ecodrivingDecelarationHigh = "dk_common_ecodriving_decel_high",
