...
struct CrashFeedbackStep1ViewModel {
    ...
    func getMessageAttributedText() -> NSAttributedString {
        let titleString = "dk_crash_detection_feedback_step1_title"
        ...
        let descriptionString = "dk_crash_detection_feedback_step1_description"
            .dkTripAnalysisLocalized()
            .dkAttributedString()
            .font(dkFont: .primary, style: DKStyle(size: 14, traits: nil))
            .color(DKUIColors.mainFontColor.color.withAlphaComponent(0.36))
            .build()
