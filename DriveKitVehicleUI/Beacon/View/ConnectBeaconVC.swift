...
public class ConnectBeaconVC: DKUIViewController {
    ...
    private func configureView() {
        titleLabel.attributedText = "dk_vehicle_beacon_setup_guide_title"
            .dkVehicleLocalized()
            .dkAttributedString()
        ...
        step1Label.attributedText = "dk_vehicle_beacon_setup_guide_desc1"
            .dkVehicleLocalized()
            .dkAttributedString()
        ...
        step2Label.attributedText = "dk_vehicle_beacon_setup_guide_desc2"
            .dkVehicleLocalized()
            .dkAttributedString()
            .font(dkFont: .primary, style: .normalText)
            .color(.complementaryFontColor)
        ...
        step3Label.attributedText = "dk_vehicle_beacon_setup_guide_desc3"
            .dkVehicleLocalized()
            .dkAttributedString()
            .font(dkFont: .primary, style: .normalText)
            .color(.complementaryFontColor)
