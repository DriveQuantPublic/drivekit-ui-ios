...
target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.16.0'
  circular_progress_ring
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.16.0'
  circular_progress_ring
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.16.0'
  circular_progress_ring
end
  
target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.16.0'
  pod 'DriveKitTripAnalysis', '1.16.0'
end
