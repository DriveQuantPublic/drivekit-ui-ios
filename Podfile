...
target 'DriveKitApp' do
  pod 'ChartsForDK'
  pod 'DriveKitTripSimulator', '1.31-beta12'
  swiftlint
end


target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.31-beta12'
...
target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.31-beta12'
  circular_progress_ring
  swiftlint
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.31-beta12'
  circular_progress_ring
  swiftlint
end

target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.31-beta12'
  pod 'DriveKitTripAnalysis', '1.31-beta12'
  swiftlint
end
...
target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.31-beta12'
  swiftlint
end
