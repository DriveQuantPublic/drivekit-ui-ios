...
target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.11-beta9'
  circular_progress_ring
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.11-beta9'
  circular_progress_ring
end
...
target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.11-beta9'
  pod 'DriveKitTripAnalysis', '1.11-beta9'
end

target 'DriveKitPermissionsUtilsUI' do
  pod 'DriveKitCore', '1.11-beta9'
end
