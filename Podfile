...
target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.12-beta5'
  circular_progress_ring
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.12-beta5'
  circular_progress_ring
end
...
target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.12-beta5'
  pod 'DriveKitTripAnalysis', '1.12-beta5'
end

target 'DriveKitPermissionsUtilsUI' do
  pod 'DriveKitCore', '1.12-beta5'
end

target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.12-beta5'
end
