...
target 'DriveKitApp' do
  pod 'ChartsForDK'
  pod 'DriveKitTripSimulator', '1.31-beta7'
  swiftlint
end


target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.31-beta7'
...
target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.31-beta7'
  circular_progress_ring
  swiftlint
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.31-beta7'
  circular_progress_ring
  swiftlint
end

target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.31-beta7'
  pod 'DriveKitTripAnalysis', '1.31-beta7'
  swiftlint
end
...
target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.31-beta7'
  swiftlint
end
