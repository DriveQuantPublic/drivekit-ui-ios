...
target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.11-beta5'
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.11-beta5'
...
target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.11-beta5'
  pod 'DriveKitTripAnalysis', '1.11-beta5'
end

target 'DriveKitPermissionsUtilsUI' do
  pod 'DriveKitCore', '1.11-beta5'
end
