...
target 'DriveKitApp' do
  ...
  pod 'DriveKitTripSimulator', '1.41-beta1'
  swiftlint
end


target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.41-beta1'
  swiftlint
end
...
target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.41-beta1'
  swiftlint
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.41-beta1'
  swiftlint
end

target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.41-beta1'
  pod 'DriveKitTripAnalysis', '1.41-beta1'
  swiftlint
end
...
target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.41-beta1'
  swiftlint
end
