...
target 'DriveKitApp' do
  ...
  pod 'DriveKitTripSimulator', '1.28-beta1'
end


target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.28-beta1'
  circular_progress_ring
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.28-beta1'
  circular_progress_ring
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.28-beta1'
  circular_progress_ring
end

target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.28-beta1'
  pod 'DriveKitTripAnalysis', '1.28-beta1'
end
...
target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.28-beta1'
end
