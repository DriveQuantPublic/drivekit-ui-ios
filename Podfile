...
target 'DriveKitDriverDataUI' do
  pod 'DriveKitDriverData', '1.20-beta1'
  circular_progress_ring
end

target 'DriveKitDriverAchievementUI' do
  pod 'DriveKitDriverAchievement', '1.20-beta1'
  circular_progress_ring
end

target 'DriveKitCommonUI' do
  pod 'DriveKitCore', '1.20-beta1'
  circular_progress_ring
end

target 'DriveKitVehicleUI' do
  pod 'DriveKitVehicle', '1.20-beta1'
...
target 'DriveKitChallengeUI' do
  pod 'DriveKitChallenge', '1.20-beta1'
end
